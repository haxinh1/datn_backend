...
class CartItemController extends Controller
{
    ...
    /**
     * 📌 Thêm sản phẩm vào giỏ hàng (Cho cả khách vãng lai & người dùng đăng nhập)
     */
    public function store(Request $request, $productId)
    {
        try {
            // 🟢 Kiểm tra token và xác thực user nếu có
            $userId = null;
            ...
            // 🔹 Nếu không có user, đảm bảo session ID của khách vãng lai
            if (!$userId) {
                if (!$sessionId) {
            ...
            // 🟢 Debug thông tin trước khi tiếp tục
            Log::info('🔍 Kiểm tra user trước khi thêm vào giỏ hàng:', [
