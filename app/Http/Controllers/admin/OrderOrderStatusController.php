    ...
    public function batchUpdateByStatus(Request $request)
{
    ...
    try {
        ...
        if (!isset($validStatusTransitions[$request->current_status]) ||
        ...
        foreach ($orders as $order) {
            ...
            OrderOrderStatus::create([
                ...
                'modified_by' => Auth::id(),
                'note' => 'Cập nhật trạng thái từ ' . $request->current_status . ' sang ' . $request->new_status,
                'employee_evidence' => 'Admin cập nhật trạng thái',
            ]);
        }
