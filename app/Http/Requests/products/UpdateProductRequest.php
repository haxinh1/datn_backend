...
use Illuminate\Validation\Rule; // <- cần thêm dòng này
...
class UpdateProductRequest extends FormRequest
{
    ...
    public function messages(): array
    {
        return [
            ...
            'name.required' => 'Tên sản phẩm là bắt buộc khi cập nhật.',
            ...
            'thumbnail.required' => 'Ảnh đại diện là bắt buộc khi cập nhật.',
